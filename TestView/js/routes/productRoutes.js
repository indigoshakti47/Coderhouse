...
const mock_server_1 = require("../mock-server/mock-server");
const Producto_1 = __importDefault(require("../service/Producto"));
const router = express_1.default.Router();
exports.router = router;
let producto = new Producto_1.default();
router.get('/vista-test', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const cant = (_a = req.query.cant) === null || _a === void 0 ? void 0 : _a.toString();
        const products = mock_server_1.createFakeData(cant);
        let empty = false;
